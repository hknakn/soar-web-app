  ...
  return (
    <div className="grid grid-cols-12 gap-6 mt-6">
      ...
      <div className="col-span-5 flex flex-col">
        ...
        <div className="bg-white rounded-[25px] py-10 px-6 flex-1">
          <div className="h-full flex flex-col justify-between">
            <div className="flex items-center justify-center gap-4">
              {showPrevious && (
                <button
                  onClick={handlePrevious}
                  className="w-[72px] h-[72px] rounded-full bg-white shadow-[0px_4px_25px_0px_rgba(76,103,100,0.10)] hover:bg-[#F8FAFC] transition-colors duration-200 flex items-center justify-center rotate-180"
                >
                  <svg
                    width="24"
                    height="24"
              ...
              {hasMoreUsers && (
                <button
                  onClick={handleNext}
                  className="w-[72px] h-[72px] rounded-full bg-white shadow-[0px_4px_25px_0px_rgba(76,103,100,0.10)] hover:bg-[#F8FAFC] transition-colors duration-200 flex items-center justify-center"
                >
                  <svg
                    width="24"
                    height="24"
            ...
            <div className="mt-8">
              <div className="relative flex items-center">
                <div className="flex items-center gap-3 w-full">
                  <span className="text-[#718EBF] text-[15px] font-medium">
                    Write Amount
                  </span>
                  <div className="relative flex-1">
                    <input
                      type="text"
                      placeholder="525.50"
                      className="w-full bg-[#EDF1F7] border-none text-[15px] text-[#232323] font-medium px-6 h-[56px] rounded-full focus:outline-none"
                    />
                    <button className="absolute right-0 top-1/2 -translate-y-1/2 h-full px-8 bg-[#232323] hover:bg-[#232323]/90 rounded-full text-[15px] font-medium text-white flex items-center gap-3 transition-colors duration-200">
                      Send
                      <SendIcon className="w-[26px] h-[22px]" />
                    </button>
                  </div>
                </div>
              </div>
